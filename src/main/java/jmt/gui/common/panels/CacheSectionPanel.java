...
public class CacheSectionPanel extends WizardPanel implements CommonConstants {
	...
	public CacheSectionPanel(StationDefinition sd, ClassDefinition cd,
			Object stationKey) {
