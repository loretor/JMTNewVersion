...
public class FiringSectionPanel extends WizardPanel implements CommonConstants {
	...
	public void setData(StationDefinition sd, ClassDefinition cd, Object sk) {
		...
		classData = cd;
		stationKey = sk;
		stationInKeys = stationData.getBackwardConnections(stationKey);
	...
	private void initComponents() {
		...
		firingPane.setMinimumSize(new Dimension((int)(300 * CommonConstants.widthScaling), (int)(240 * CommonConstants.heightScaling)));
