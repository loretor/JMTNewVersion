...
import jmt.gui.jmva.eval.Evaluator;
import jmt.gui.jmva.eval.FastEvaluator;
...
public class LDEditingWindow extends JMTDialog {
	...
	JComponent makeTools() {
		...
		ldExpression.setMaximumSize(new Dimension((int)(10000 * CommonConstants.widthScaling), (int)(22 * CommonConstants.heightScaling)));
