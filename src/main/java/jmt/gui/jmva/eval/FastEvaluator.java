...
public class FastEvaluator implements Evaluator {
	...
	/* (non-Javadoc)
	 * @see jmt.gui.jmva.ld.eval.ld.Evaluator#evaluate(java.lang.String, double)
	 */
	...
	/* (non-Javadoc)
	 * @see jmt.gui.jmva.ld.eval.ld.Evaluator#evaluate(java.lang.String, double[], double[])
	 */
	...
	/* (non-Javadoc)
	 * @see jmt.gui.jmva.ld.eval.ld.Evaluator#getHelpText()
	 */
