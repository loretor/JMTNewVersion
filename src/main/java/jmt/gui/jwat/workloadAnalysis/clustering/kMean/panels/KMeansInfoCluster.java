...
public class KMeansInfoCluster extends JPanel implements CommonConstants, JWATConstants {
	...
	private JScrollPane getClusterList() {
		...
		p.setPreferredSize(new Dimension((int)(120 * CommonConstants.widthScaling), (int)(115 * CommonConstants.heightScaling)));
		return p;
	}
	...
	private class clustTableModel extends AbstractTableModel {
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			if (rowIndex < data.length) {
				...
				if (columnIndex == 2) {
					return defaultFormat.format(data[rowIndex].dMean);
				}
				if (columnIndex == 3) {
