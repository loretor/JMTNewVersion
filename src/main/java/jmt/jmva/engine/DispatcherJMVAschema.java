...
public class DispatcherJMVAschema {
	...
	public boolean solveModel() {
		...
		transfSuccess = md.MVAtoSIM(modelDefinitionPath, simModelDefinitionPath);
	...
	public ExactModel getTransformedModel(String inputModel, String outputModel) {
		...
		List<String> warnings = JMVAtoJSIMConvertor.convert(exact, simModel);
