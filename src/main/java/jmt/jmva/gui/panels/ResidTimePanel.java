...
public final class ResidTimePanel extends SolutionPanel {
	...
	public ResidTimePanel(JMVAWizard ew, SolverAlgorithm alg) {
		super(ew, alg);
	...
	protected void sync() {
		...
		stationAggs = data.getPerStationResidT(algorithm);
		/* END */
	}
