...
public class JmvaGuiTest {
	...
	public void setUp() {
		...
		jmva = WindowFinder.findFrame(JMVAWizard.class).using(window.robot);
	}
	...
	public void JMVAhelpWindowDisplaysCorrectly() {
		...
		FrameFixture helpWindow = WindowFinder.findFrame(PDFViewer.class).using(jmva.robot);
		helpWindow.close();
	}
	...
	public void JMVAopenNewModel() {
		...
		FrameFixture newJmva = WindowFinder.findFrame(JMVAWizard.class).using(jmva.robot);
		newJmva.close();
	}
